                        ...
                        <div className="hidden sm:flex items-center">
                            {routes.map((route) => (
                                <Link
                                    key={route.to}
                                    to={route.to}
                                    className="text-white font-semibold md:pe-5 sm:text-[14px] sm:pe-3 md:text-[20px] hover:bg-sky-700 xl:py-2 xl:px-6 rounded"
                                >
                                    {route.text}
                                </Link>
                            ))}
                        ...
                        <div className="flex flex-col items-center ps-4 pe-3">
                            <button className="hidden sm:block sm:ps-5 sm:pe-4 ps-10 pe-7">
                                <svg
                                    ...
                                    viewBox="0 0 24 24"
                                    fill="currentColor"
                                    className="text-white sm:size-6 lg:size-8"
                                >
                                    <path
                                        fillRule="evenodd"
